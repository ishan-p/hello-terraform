...
module "load_balancers" {
  ...
  app_private_instance1_subnet1_id = module.instances.app_private_instance1_subnet1_id
  app_private_instance2_subnet1_id = module.instances.app_private_instance2_subnet1_id
  app_private_instance1_subnet2_id = module.instances.app_private_instance1_subnet2_id
}
